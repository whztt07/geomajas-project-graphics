...
/**
 * Generic controller that creates a {@link org.geomajas.graphics.client.object.Resizable}.
 *
 * @author Jan Venstermans
 * @param <T>
 *
 */
public class CreateLabeledRectangleController<T extends GraphicsObject>
	...
	/**
	 * Create the object. This object should support the {@link org.geomajas.graphics.client.object.Resizable} role.
	 * 
	 * @return
	 */
		protected GraphicsObject createObject() {
		return new LabeledRectangle(0, 0, 0, 0);
	}
	...
	public void onMouseDown(MouseDownEvent event) {
		...
		if (dragResizable == null) {
			...
			dragResizable.getRole(Draggable.TYPE).setUserBounds(new Bbox(begin.getX(), begin.getY(), 0, 0));
