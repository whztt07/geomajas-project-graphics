...
/**
 * Factory for the {@link AnchorController}.
 * 
 * @author Jan De Moerloose
 * 
 */
public class AnchorControllerFactory implements GraphicsControllerFactory {
	...
	public GraphicsController createController(GraphicsService graphicsService, GraphicsObject object) {
		return new AnchorController(object, graphicsService);
	}
