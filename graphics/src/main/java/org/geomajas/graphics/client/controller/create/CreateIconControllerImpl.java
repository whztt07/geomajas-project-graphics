 ...
 * 
 */
public class CreateIconControllerImpl extends CreateController<GIcon> implements MouseUpHandler, CreateIconController {
	...
	public CreateIconControllerImpl(GraphicsService graphicsService, int width, int height, List<String> hrefs) {
