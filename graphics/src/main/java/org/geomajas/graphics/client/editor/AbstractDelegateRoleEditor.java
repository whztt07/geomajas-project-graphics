 ...
 *
 * @param <T> the {@link org.geomajas.graphics.client.object.RoleInterface} that will contain reference
 *           to a delegate role.
 * @param <D> the delegate {@link org.geomajas.graphics.client.editor.AbstractRoleEditor}
 * @author Jan Venstermans
 */
public abstract class AbstractDelegateRoleEditor<T extends RoleInterface, D extends AbstractRoleEditor>
