...
public class SliderBar extends FocusPanel implements RequiresResize, HasValue<Double>, HasValueChangeHandlers<Double> {
	...
	private static final String SLIDER_LEFT = "transparency-SliderBar-left";
	private static final String SLIDER_RIGHT = "transparency-SliderBar-right";
	private static final String SLIDER_LINE = "transparency-SliderBar-line";
	private static final String SLIDER_KNOB = "transparency-SliderBar-knob";
	private static final String SLIDER_LINE_SLIDING = "transparency-SliderBar-line-sliding";
	private static final String SLIDER_KNOB_SLIDING = "transparency-SliderBar-knob-sliding";
	private static final String SLIDER_TICK = "transparency-SliderBar-tick";
	private static final String SLIDER_TICK_SLIDING = "transparency-SliderBar-tick-disabled";
	private static final String SLIDER_SHELL = "transparency-SliderBar-shell";
	private static final String SLIDER_LINE_DISABLED = "transparency-SliderBar-line-disabled";
	private static final String SLIDER_PANEL = "transparency-SliderBar-panel";
	 ...
	 */
	private Button knobImage = new Button();
	...
	public SliderBar(double minValue, double maxValue, LabelFormatter labelFormatter) {
		...
		DOM.setStyleAttribute(knobElement, "backgroundImage", "url('" + GWT.getModuleBaseURL() + "image/slider.gif')");
		DOM.setElementProperty(knobElement, "className", SLIDER_KNOB);
