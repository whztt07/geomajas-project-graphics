...
/**
 * Extension of {@link UpdateableGroupGraphicsObject} that shows a text centered on a rectangle.
 *
...
public class LabeledRectangle extends UpdateableGroupGraphicsObject {
	...
	public LabeledRectangle(double userX, double userY, double width, double height) {
		// create base graphics objects
		baseRectangle = new BaseRectangle(userX, userY, width, height);
		labeled = new LabeledImpl(baseRectangle, "Rectangle");
	...
	public Object cloneObject() {
		...
		LabeledRectangle labeledRectangleClone = new LabeledRectangle(userBounds.getX(),
				userBounds.getY(), userBounds.getWidth(), userBounds.getHeight());
