 ...
 * 
 */
public class DragResizableControllerFactory implements GraphicsControllerFactory {
	
	private boolean dragOnActivate;
	
	public DragResizableControllerFactory() {
		this(true);
	}

	public DragResizableControllerFactory(boolean dragOnActivate) {
