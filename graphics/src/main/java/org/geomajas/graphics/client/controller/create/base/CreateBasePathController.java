 ...
 *
 */
public class CreateBasePathController extends CreateController<BasePath> implements MouseDownHandler, MouseMoveHandler,
	...
	public CreateBasePathController(GraphicsService graphicsService, boolean closedPath) {
	...
	protected BasePath createPath() {
		BasePath path = new BasePath(new Coordinate(0, 0), isClosedPath());
